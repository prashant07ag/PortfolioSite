...
type ProjectDocumentDataSlicesSlice = ImageBlockSlice;
...
interface ProjectDocumentData {
  ...
  /**
   * Deployment field in *Project*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: project.deployment
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  deployment: prismic.LinkField;

  /**
   * Deployment label field in *Project*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project.deployment_label
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  deployment_label: prismic.KeyTextField;
  ...
  /**
   * Repo Label field in *Project*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: project.repo_label
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  repo_label: prismic.KeyTextField;
...
interface SettingsDocumentData {
  ...
  /**
   * Gmail field in *Settings*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.gmail
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
...
export interface BiographySliceDefaultPrimary {
  ...
  /**
   * Avtar field in *Biography → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: biography.primary.avtar
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
/**
 * Primary content in *Experince → Primary*
 */
export interface ExperinceSliceDefaultPrimary {
  /**
   * Heading field in *Experince → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experince.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;
}
...
/**
 * Primary content in *Experince → Items*
 */
export interface ExperinceSliceDefaultItem {
  /**
   * Title field in *Experince → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experince.items[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;

  /**
   * Time Period field in *Experince → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experince.items[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Institution field in *Experince → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experince.items[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  institution: prismic.KeyTextField;

  /**
   * Description field in *Experince → Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experince.items[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
/**
 * Default variation for Experince Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExperinceSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ExperinceSliceDefaultPrimary>,
  Simplify<ExperinceSliceDefaultItem>
>;

/**
 * Slice variation for *Experince*
 */
type ExperinceSliceVariation = ExperinceSliceDefault;

/**
 * Experince Shared Slice
 *
 * - **API ID**: `experince`
 * - **Description**: Experince
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExperinceSlice = prismic.SharedSlice<
  "experince",
  ExperinceSliceVariation
>;
...
export interface HeroSectionSliceDefaultPrimary {
  /**
   * FirstName field in *HeroSection → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_section.primary.firstname
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  firstname: prismic.KeyTextField;

  /**
   * LastName field in *HeroSection → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_section.primary.lastname
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  lastname: prismic.KeyTextField;

  /**
   * Tagline field in *HeroSection → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero_section.primary.tagline
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExperinceSlice,
      ExperinceSliceDefaultPrimary,
      ExperinceSliceDefaultItem,
      ExperinceSliceVariation,
      ExperinceSliceDefault,
      HeroSectionSlice,
