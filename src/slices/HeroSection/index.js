...
import { Shapes } from "@/slices/HeroSection/Shapes";
    ...
    >
      <div className="grid min-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className=" col-start-1 md:row-start-1">
          <h1 className="mb-8 text-[clamp(3rem,20vmin,17rem)] font-extrabold leading-none tracking-tighter" aria-label={
          ...
          <span className="job-title block bg-gradient-to-tr from-yellow-500 via-blue-200 to-yellow-500 bg-clip-text text-2xl font-bold uppercase tracking-[.2em] text-transparent md:text-4xl">
